...
<div class="container-fluid">
	...
	<div class="row">
		<div class="col-lg">
			...
			<a href="#" class="btn btn-sm btn-primary mb-3" data-toggle="modal" data-target="#newMenuModal">Add New Menu</a>
			<a href="<?= base_url('menu/menu_order'); ?>" title="" class="btn btn-sm btn-info mb-3"><i class="fas fa-fw fa-list"></i> Order Menu</a>
				...
				<tbody>
					...
					<?php foreach ($menu as $mn) : ?>
						<tr>
							...
							<td><?= $mn['menu']; ?></td>
							<td>
								<a href="<?= base_url('menu/edit_form/' . $mn['id']); ?>" class="badge badge-success">Edit</a>
								<a href="" onclick="confirm_modal('<?= site_url('menu/delete/' . $mn['id']); ?>')" data-toggle="modal" data-target="#deleteMenu" class="badge badge-danger">Delete</a>
							</td>
						</tr>
					<?php endforeach; ?>
				</tbody>
