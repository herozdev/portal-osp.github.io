		...
		<div class="col-md-12">
			...
			<div id="tabsContent" class="tab-content">
				<div id="home1" class="tab-pane fade active show">
					<a href="<?= base_url('admin/excel_monitoring_inv'); ?>" class="btn btn-sm btn-success mb-3"><i class="fas fa-fw fa-download"></i> Export Excel</a>
				...
				<div id="profile1" class="tab-pane fade">
					<a href="<?= base_url('admin/excel_monitoring_expl'); ?>" class="btn btn-sm btn-success mb-3"><i class="fas fa-fw fa-download"></i> Export Excel</a>
					<table class="table align-items-center table-flush table-bordered">
						<thead class="thead-dark">
							<tr>
								<th rowspan="2" style="text-align: center; vertical-align:middle; font-size:small;">Pengadaan/Kegiatan</th>
				...
				<div id="nav1" class="tab-pane fade">
