...
<div class="container-fluid">
  ...
  <div class="row">
    <div class="col-lg">
      ...
      <a href="<?= base_url('user/pengadaan_inv/'); ?>" class="btn btn-sm btn-warning mb-3"><i class="fas fa-undo-alt"></i> Back</a>
      ...
      <table class="table table-responsive table-flush table-bordered">
        <thead class="thead-dark">
          <tr>
            ...
            <?php
            foreach ($data_inv->result() as $inv) {
              echo "<th>$inv->tahun</th>";
            }
            ?>
        ...
        <tbody>
          ...
          ?>
            <tr>
              ...
              <td><?php echo $view->jenis_investasi; ?></td>
              ...
              <?php
              foreach ($data_inv->result() as $terr) {
              ...
              <?php
              foreach ($fiat_inv->result() as $woyo) {
