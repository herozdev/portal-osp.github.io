...
<div class="container-fluid">
  ...
  <div class="row">
    <div class="col-lg">
      ...
      <a href="<?= base_url('user/export_excel_expl/'); ?>" class="btn btn-sm btn-success mb-3"><i class="fas fa-fw fa-download"></i> Export Excel</a>
        ...
        <tbody id="myTable">
          ...
          ?>
            <tr data-toggle="collapse" data-target="#demo1" class="accordion-toggle">
              <td><?= ++$no; ?></td>
              <td style="text-align: center; vertical-align:middle; font-size:small;"><?= $expl['pemutus']; ?></td>
              <td style="text-align: center; vertical-align:middle; font-size:small;"><?= $expl['uker']; ?></td>
              ...
              <td style="text-align: center; vertical-align:middle; font-size:small;"><?= $expl['jenis_eksploitasi']; ?></td>
              <td style="text-align: center; vertical-align:middle; font-size:small;"><?= $expl['kategori']; ?></td>
              <td style="text-align: center; vertical-align:middle; font-size:small;"><?= $expl['kegiatan']; ?></td>
              ...
              <td style="text-align: center; vertical-align:middle; font-size:small;">
                <a href="<?= site_url('user/edit_pengadaan_expl/' . $expl['id']); ?>" class="badge badge-success"><i class="fas fa-fw fa-pencil-alt"></i> Edit</a>
                <a href="" onclick="confirm_modal('<?= site_url('user/delete_expl/' . $expl['id']); ?>')" data-toggle="modal" data-target="#deleteMenu" class="badge badge-danger"><i class="fas fa-fw fa-trash-alt"></i> Delete</a>
                <a href="<?= site_url('user/view_expl/' . $expl['id']); ?>" class="badge badge-primary"><i class="fas fa-info-circle"></i> Detail</a>
          ...
          <?php
            ...
            $sum_spk_now += $expl['spk_now'];
            $sum_fiat_inv += $expl['total'];
          endforeach;
          ?>
        </tbody>
      </table>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="newMenuModalLabel">Tambah Pengadaan Eksploitasi</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <form action="<?= base_url('user/submit_expl'); ?>" method="POST">
        <div class="modal-body">
          ...
          <div class="form-group">
            <select name="kode_kategori" id="kategoriexpl" class="form-control col-md-7 col-xl-12">
              <option value="">-PILIH-</option>
            </select>
          </div>
          <div class="form-group">
