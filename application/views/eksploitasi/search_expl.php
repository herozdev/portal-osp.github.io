...
<div class="container-fluid">
  ...
  if (isset($_REQUEST['keyword']) && $_REQUEST['keyword'] != '') {
    ...
    $sql = "SELECT a.id,a.kode_rka,a.kode_jenis,a.kode_kategori,a.kode_kegiatan,a.kegiatan,a.alokasi_baru,a.sisa_alokasi_baru,a.alokasi_carry_over,a.sisa_alokasi_carry_over,a.keterangan,b.jenis_eksploitasi,c.kategori FROM eksploitasi a LEFT JOIN sub_expl b ON a.kode_jenis=b.kode_jenis LEFT JOIN sub_expl_kategori c ON a.kode_kategori=c.kode_kategori WHERE b.jenis_eksploitasi LIKE '%$keyword%' OR a.kode_rka LIKE '%$keyword%' OR a.kegiatan LIKE '%$keyword%' OR c.kategori LIKE '%$keyword%' ORDER BY a.id";
    $result = mysqli_query($con, $sql);
  } else {
    //            jika tidak ada pencarian pakai ini
    $reload = 'search_expl.php?pagination=true';
    $sql = 'SELECT a.id,a.kode_rka,a.kode_jenis,a.kode_kategori,a.kode_kegiatan,a.kegiatan,a.alokasi_baru,a.sisa_alokasi_baru,a.alokasi_carry_over,a.sisa_alokasi_carry_over,a.keterangan,b.jenis_eksploitasi,c.kategori FROM eksploitasi a LEFT JOIN sub_expl b ON a.kode_jenis=b.kode_jenis LEFT JOIN sub_expl_kategori c ON a.kode_kategori=c.kode_kategori ORDER BY a.id';
    $result = mysqli_query($con, $sql);
  }
  ...
  <div class="row">
    <div class="col-lg">
      ...
      <a href="<?= base_url('admin/expl'); ?>" class="btn btn-sm btn-danger mb-3"><i class="fas fa-times"></i> Clear</a>
      <form action="<?php echo base_url('admin/excel_filter_expl'); ?>" method="POST">
        ...
        <tbody id="myTable">
          ...
          <?php foreach ($key->result_array() as $vv) : ?>
            <tr data-toggle="collapse" data-target="#demo1" class="accordion-toggle">
              ...
              <td><?php echo $vv['jenis_eksploitasi']; ?></td>
              <td><?= $vv['kategori']; ?></td>
              ...
              <td><?= $vv['keterangan']; ?></td>
              <td>
                <a href="<?= base_url('admin/edit_form_expl/' . $vv['id']); ?>" class="badge badge-success">Edit</a>
                <a href="" onclick="confirm_modal('<?= site_url('admin/delete_expl/' . $vv['id']); ?>')" data-toggle="modal" data-target="#deleteMenu" class="badge badge-danger">Delete</a>
              </td>
            </tr>
            <tr class="p">
