...
<div class="container-fluid">
  ...
  <div class="row">
    <div class="col-lg">
      ...
      <a href="<?= base_url('admin/excel_expl'); ?>" class="btn btn-sm btn-success mb-3"><i class="fas fa-fw fa-download"></i> Export Excel</a>

      <form action="<?= base_url('admin/search_expl'); ?>" method="POST">
      ...
      <table class="table align-items-center table-flush table-bordered">
        <thead class="thead-dark">
          <tr>
            ...
            <th style="text-align: center; vertical-align:middle; font-size:small;">Jenis Eksploitasi</th>
            <th style="text-align: center; vertical-align:middle; font-size:small;">Kategori</th>
        ...
        <tbody id="myTable">
          ...
          $sum_sisa_carry = 0;
          ?>
          <?php foreach ($expl as $vv) : ?>
            <tr data-toggle="collapse" data-target="#demo1" class="accordion-toggle">
              <td><?= ++$no; ?></td>
              <td style="text-align: center; vertical-align:middle; font-size:small;"><?= $vv['kode_rka']; ?></td>
              <td style="text-align: center; vertical-align:middle; font-size:small;"><?= $vv['jenis_eksploitasi']; ?></td>
              <td style="text-align: center; vertical-align:middle; font-size:small;"><?= $vv['kategori'] ?></td>
              <td style="text-align: center; vertical-align:middle; font-size:small;"><?= $vv['kegiatan']; ?></td>
              <td style="text-align: center; vertical-align:middle; font-size:small;"><?= number_format($vv['alokasi_baru']); ?></td>
              <td style="text-align: center; vertical-align:middle; font-size:small;"><?= number_format($vv['sisa_alokasi_baru']); ?></td>
              <td style="text-align: center; vertical-align:middle; font-size:small;"><?= $vv['keterangan']; ?></>
              <td>
                <a href="<?= base_url('admin/edit_form_expl/' . $vv['id']); ?>" class="badge badge-success"><i class="fas fa-fw fa-pencil-alt"></i> Edit</a>
                <a href="" onclick="confirm_modal('<?= site_url('admin/delete_expl/' . $vv['id']); ?>')" data-toggle="modal" data-target="#deleteMenu" class="badge badge-danger"><i class="fas fa-fw fa-trash-alt"></i> Delete</a>
              </td>
            </tr>
            <tr class="p">
...
<div class="modal fade" id="newBreakdown" tabindex="-1" role="dialog" aria-labelledby="newBreakdownLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="<?= base_url('admin/expl'); ?>" method="POST">
          ...
          <div class="form-group">
            <select name="kode_jenis" class="form-control">
              ...
              <?php foreach ($jenis as $ok) : ?>
                <option value="<?= $ok['kode_jenis']; ?>"><?= $ok['jenis_eksploitasi']; ?></option>
              <?php endforeach; ?>
            </select>
          </div>
          <div class="form-group">
            <select name="kode_kategori" class="form-control">
              ...
              <?php foreach ($kategori as $kat) : ?>
                <option value="<?= $kat['kode_kategori']; ?>"><?= $kat['kategori']; ?></option>
              <?php endforeach; ?>
            </select>
          </div>
          <div class="form-group">
            <input type="hidden" name="kode_kegiatan" value="<?= $kodekat; ?>">
            <input type="text" name="kegiatan" class="form-control" placeholder="Kegiatan">
          </div>
          <div class="form-group">
            <input type="text" name="alokasi_baru" class="form-control" placeholder="Alokasi Baru" id="rupiah1" onkeypress="return hanyaAngka(event)">
          </div>
          <div class="form-group">
            <input type="text" name="sisa_alokasi_baru" class="form-control" id="rupiah2" placeholder="Konfirmasi Alokasi Baru" onkeypress="return hanyaAngka(event)">
          </div>
          <div class="form-group">
            <input type="text" name="alokasi_carry_over" class="form-control" id="rupiah3" placeholder="Alokasi Carry Over" onkeypress="return hanyaAngka(event)">
          </div>
          <div class="form-group">
            <input type="text" name="sisa_alokasi_carry_over" class="form-control" id="rupiah4" placeholder="Konfirmasi Alokasi Carry Over" onkeypress="return hanyaAngka(event)">
          </div>
          <div class="form-group">
