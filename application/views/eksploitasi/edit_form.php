...
<div class="container-fluid">
  ...
  <div class="row">
    <div class="col-lg">
      ...
      <div class="form-group">
        ...
        <select name="kode_jenis" class="form-control" id="kode_jenis">
          ...
          <?php foreach ($jenis as $m) : ?>
            <option value="<?= $m['kode_jenis']; ?>"><?= $m['jenis_eksploitasi']; ?></option>
          <?php endforeach; ?>
        </select>
      </div>
      <div class="form-group row">
        <div class="col-sm-6 mb-3 mb-sm-0">
          ...
          <select name="kode_kategori" class="form-control" id="kode_kategori">
            <option value="">-PILIH-</option>
            <?php foreach ($kategori as $z) : ?>
              <option value="<?= $z['kode_kategori']; ?>"><?= $z['kategori']; ?></option>
            <?php endforeach; ?>
          </select>
        </div>
        <div class="col-sm-6">
      ...
      <div class="form-group">
        <a href="<?= base_url('admin/expl'); ?>" class="btn btn-outline-warning">Back</a>
